...
CREATE TABLE IF NOT EXISTS sandbox.city_position_features_ge (
    ...
    location_rk                   TEXT        NOT NULL DEFAULT '',
    location_nm                   TEXT,
    position_name                 TEXT,
    ext_salary_mean               NUMERIC(18,5),
    ext_salary_p25                NUMERIC(18,5),
    ext_salary_p50                NUMERIC(18,5),
    ext_salary_p75                NUMERIC(18,5),
    ext_vacancy_cnt               NUMERIC(18,5),
    ext_vacancy_hrm               NUMERIC(18,5),
    ext_vacancy_sal_range         NUMERIC(18,5),
    turnover_coeff                NUMERIC(18,5),
    required_positions            NUMERIC(18,5),
    occupied_positions            NUMERIC(18,5),
    normalized_positions          NUMERIC(18,5),
    headcount_gap                 NUMERIC(18,5),
    average_inhouse_headcount_coeff NUMERIC(18,5),
    average_headcount_coeff       NUMERIC(18,5),
    dismissal_int_reason_group_nm TEXT,
    dismissal_cnt                 NUMERIC(18,5),
    int_salary_tc5                NUMERIC(18,5),
    target_salary_amt             NUMERIC(18,5),
    competitor_nm                 TEXT,
    competitor_type               TEXT,
    competitor_food_cat           TEXT,
    post_cnt                      NUMERIC(18,5),
    agglomeration_nm              TEXT,
    gap_to_market_p50             NUMERIC(18,5),
    gap_to_market_p25             NUMERIC(18,5),
    lag1_ext_salary_p50           NUMERIC(18,5),
    lag1_ext_salary_p25           NUMERIC(18,5),
    lag1_turnover                 NUMERIC(18,5),
    rolling_mean_turnover_4w      NUMERIC(18,5),
    n_weeks_12w                   INTEGER,
    avg_vacancy_12w               NUMERIC(18,5),
    lag1_post_cnt                 NUMERIC(18,5),
    rolling_mean_post_4w          NUMERIC(18,5),
    avg_post_cnt_12w              NUMERIC(18,5),
    lag52_ext_salary_p50          NUMERIC(18,5),
    salary_p50_yoy_diff           NUMERIC(18,5),
    avg_ext_vacancy_w52           NUMERIC(18,5),
    avg_post_cnt_52w              NUMERIC(18,5),
    vacancy_cnt_yoy_diff          NUMERIC(18,5),
    lag52_turnover_coeff          NUMERIC(18,5),
    turnover_yoy_diff             NUMERIC(18,5),
    lag52_gap_to_market_p50       NUMERIC(18,5),
    lag52_gap_to_market_p25       NUMERIC(18,5),
    gap_yoy_diff                  NUMERIC(18,5),
    nulls_ratio                   NUMERIC(10,5),
...
CREATE TABLE IF NOT EXISTS sandbox.hr_problem_flags_ge (
    ...
    ext_salary_p50             NUMERIC(18,5),
    ext_salary_p75             NUMERIC(18,5),
    salary_delta_p50           NUMERIC(18,5),
    salary_delta_p25           NUMERIC(18,5),
    iso_score                  NUMERIC(18,5),
    iso_flag                   BOOLEAN,
    vac_ext_int_ratio          NUMERIC(18,5),
    headcount_gap_share        NUMERIC(18,5),
    average_inhouse_headcount_coeff NUMERIC(18,5),
    average_headcount_coeff    NUMERIC(18,5),
    salary_p50_yoy_diff        NUMERIC(18,5),
    vacancy_cnt_yoy_diff       NUMERIC(18,5),
    turnover_yoy_diff          NUMERIC(18,5),
    salary_range               NUMERIC(18,5),
    salary_std_4w              NUMERIC(18,5),
    ext_salary_p50_ema         NUMERIC(18,5),
    is_december                BOOLEAN,
    is_january                 BOOLEAN,
    is_q1                      BOOLEAN,
    is_q4                      BOOLEAN,
...
CREATE TABLE IF NOT EXISTS sandbox.hr_recommendations_ge (
    ...
    text_ru             TEXT,
    meta_json           JSONB,
    fact_salary_fte_amt NUMERIC(18,5),
    market_perc_50      NUMERIC(18,5),
    gap_to_market_p50   NUMERIC(18,5),
    cnt_vacancy_site    INTEGER,
    vacancy_cnt         INTEGER,
    target_salary       NUMERIC(18,5),
    created_at          TIMESTAMPTZ NOT NULL DEFAULT now(),
