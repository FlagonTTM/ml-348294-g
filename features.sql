...
CREATE TABLE IF NOT EXISTS sandbox.city_position_features_ge (
    ...
    dismissal_cnt INT,
    turnover_coeff NUMERIC(8,5),
    required_positions INT,
    occupied_positions INT,
    normalized_positions INT,
    headcount_gap INT,
    average_inhouse_headcount_coeff NUMERIC(8,5),
    average_headcount_coeff NUMERIC(8,5),
    ...
    gap_to_market_p50 NUMERIC(8,5),
    gap_to_market_p25 NUMERIC(8,5),
